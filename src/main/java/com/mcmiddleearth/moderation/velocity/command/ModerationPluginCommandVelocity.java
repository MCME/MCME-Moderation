...
public class ModerationPluginCommandVelocity implements SimpleCommand {
    ...
    public void execute(final Invocation invocation) {
        ...
        moderationCommand.execute(VelocityMcmeProxy.getMcmeCommandSender(source),name, args);
    }
    ...
    public CompletableFuture<List<String>> suggestAsync(final Invocation invocation) {
        ...
        return CompletableFuture.completedFuture(moderationCommand
                .getSuggestions(VelocityMcmeProxy.getMcmeCommandSender(invocation.source()),cursor));
    }
